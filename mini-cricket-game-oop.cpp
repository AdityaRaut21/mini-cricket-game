/*
    ...
    Program:	Mini Cricket Game
    Author: 	Aditya Raut, Ayushi Parkale and Ashwath Natake
    Class:      SYCO A
...
int main() {
    ...
    cout << "\n*********** Team-B needs " << teamA.runs + 1 << " runs to win ***********" << endl << endl;
...
void welcomeUsers() {
    ...
    cout << "|                                     |" << endl;
    cout << "|      Welcome to Mini Cricket        |" << endl;
    cout << "---------------------------------------" << endl;
}
